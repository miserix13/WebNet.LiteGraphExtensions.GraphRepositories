...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations
{
    ...
    public class TagMethods : ITagMethods
    {
        ...
        {
            throw new NotImplementedException("TagMethods.Create not yet implemented for DuckDB");
        }

        public Task<List<TagMetadata>> CreateMany(Guid tenantGuid, List<TagMetadata> tags, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.CreateMany not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadAllInTenant not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadAllInGraph not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadMany not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadManyGraph not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadManyNode not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadManyEdge not yet implemented for DuckDB");
        }

        public Task<TagMetadata> ReadByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.ReadByGuid not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("TagMethods.ReadByGuids not yet implemented for DuckDB");
        }

        public Task<EnumerationResult<TagMetadata>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.Enumerate not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("TagMethods.GetRecordCount not yet implemented for DuckDB");
        }

        public Task<TagMetadata> Update(TagMetadata tag, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.Update not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("TagMethods.DeleteMany not yet implemented for DuckDB");
        }

        public Task DeleteMany(Guid tenantGuid, List<Guid> guids, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteMany (by guids) not yet implemented for DuckDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteAllInTenant not yet implemented for DuckDB");
        }

        public Task DeleteAllInGraph(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteAllInGraph not yet implemented for DuckDB");
        }

        public Task DeleteGraphTags(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteGraphTags not yet implemented for DuckDB");
        }

        public Task DeleteNodeTags(Guid tenantGuid, Guid graphGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteNodeTags not yet implemented for DuckDB");
        }

        public Task DeleteEdgeTags(Guid tenantGuid, Guid graphGuid, Guid edgeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteEdgeTags not yet implemented for DuckDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.DeleteByGuid not yet implemented for DuckDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("TagMethods.ExistsByGuid not yet implemented for DuckDB");
        }
    }
}
