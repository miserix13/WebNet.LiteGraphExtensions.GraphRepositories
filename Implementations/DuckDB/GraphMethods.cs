...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations
{
    ...
    public class GraphMethods : IGraphMethods
    {
        ...
        {
            throw new NotImplementedException("GraphMethods.Create not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("GraphMethods.ReadAllInTenant not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("GraphMethods.ReadMany not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.ReadFirst not yet implemented for DuckDB");
        }

        public Task<Graph> ReadByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.ReadByGuid not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("GraphMethods.ReadByGuids not yet implemented for DuckDB");
        }

        public Task<EnumerationResult<Graph>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.Enumerate not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.GetRecordCount not yet implemented for DuckDB");
        }

        public Task<Graph> Update(Graph graph, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.Update not yet implemented for DuckDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.DeleteByGuid not yet implemented for DuckDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.DeleteAllInTenant not yet implemented for DuckDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.ExistsByGuid not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.EnableVectorIndexingAsync not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.DisableVectorIndexingAsync not yet implemented for DuckDB");
        }

        public Task<bool> ExistsByName(Guid tenantGuid, string name, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.ExistsByName not yet implemented for DuckDB");
        }

        public Task<Graph> ReadByName(Guid tenantGuid, string name, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.ReadByName not yet implemented for DuckDB");
        }

        public Task<Dictionary<Guid, GraphStatistics>> GetStatistics(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.GetStatistics not yet implemented for DuckDB");
        }

        public Task<GraphStatistics> GetStatistics(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.GetStatistics (graph) not yet implemented for DuckDB");
        }

        public Task RebuildVectorIndexAsync(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("GraphMethods.RebuildVectorIndexAsync not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.GetVectorIndexStatistics not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.GetSubgraph not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("GraphMethods.GetSubgraphStatistics not yet implemented for DuckDB");
        }
    }
}
