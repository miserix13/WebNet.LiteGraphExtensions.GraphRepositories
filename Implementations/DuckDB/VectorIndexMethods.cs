...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations
{
    ...
    public class VectorIndexMethods : IVectorIndexMethods
    {
        ...
        {
            throw new NotImplementedException("VectorIndexMethods.Create not yet implemented for DuckDB");
        }

        public Task<VectorIndexConfiguration> ReadByGraphGuid(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.ReadByGraphGuid not yet implemented for DuckDB");
        }

        public Task<VectorIndexConfiguration> Update(VectorIndexConfiguration index, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.Update not yet implemented for DuckDB");
        }

        public Task DeleteByGraphGuid(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.DeleteByGraphGuid not yet implemented for DuckDB");
        }

        public Task<bool> ExistsByGraphGuid(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.ExistsByGraphGuid not yet implemented for DuckDB");
        }

        public Task<VectorIndexConfiguration> GetConfiguration(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.GetConfiguration not yet implemented for DuckDB");
        }

        public Task<VectorIndexStatistics> GetStatistics(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.GetStatistics not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("VectorIndexMethods.EnableVectorIndex not yet implemented for DuckDB");
        }

        public Task RebuildVectorIndex(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorIndexMethods.RebuildVectorIndex not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("VectorIndexMethods.DeleteVectorIndex not yet implemented for DuckDB");
        }
    }
}
