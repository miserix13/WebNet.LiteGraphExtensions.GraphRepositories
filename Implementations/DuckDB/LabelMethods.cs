...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations
{
    ...
    public class LabelMethods : ILabelMethods
    {
        ...
        {
            throw new NotImplementedException("LabelMethods.Create not yet implemented for DuckDB");
        }

        public Task<List<LabelMetadata>> CreateMany(Guid tenantGuid, List<LabelMetadata> labels, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.CreateMany not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadAllInTenant not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadAllInGraph not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadMany not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadManyGraph not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadManyNode not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadManyEdge not yet implemented for DuckDB");
        }

        public Task<LabelMetadata> ReadByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.ReadByGuid not yet implemented for DuckDB");
        }
        ...
        { yield break; throw new NotImplementedException("LabelMethods.ReadByGuids not yet implemented for DuckDB");
        }

        public Task<EnumerationResult<LabelMetadata>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.Enumerate not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("LabelMethods.GetRecordCount not yet implemented for DuckDB");
        }

        public Task<LabelMetadata> Update(LabelMetadata label, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.Update not yet implemented for DuckDB");
        }
        ...
        {
            throw new NotImplementedException("LabelMethods.DeleteMany not yet implemented for DuckDB");
        }

        public Task DeleteMany(Guid tenantGuid, List<Guid> guids, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteMany (by guids) not yet implemented for DuckDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteAllInTenant not yet implemented for DuckDB");
        }

        public Task DeleteAllInGraph(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteAllInGraph not yet implemented for DuckDB");
        }

        public Task DeleteGraphLabels(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteGraphLabels not yet implemented for DuckDB");
        }

        public Task DeleteNodeLabels(Guid tenantGuid, Guid graphGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteNodeLabels not yet implemented for DuckDB");
        }

        public Task DeleteEdgeLabels(Guid tenantGuid, Guid graphGuid, Guid edgeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteEdgeLabels not yet implemented for DuckDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.DeleteByGuid not yet implemented for DuckDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("LabelMethods.ExistsByGuid not yet implemented for DuckDB");
        }
    }
}
