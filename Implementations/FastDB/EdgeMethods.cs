...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations.FastDB
{
    ...
    public class EdgeMethods : IEdgeMethods
    {
        ...
        {
            throw new NotImplementedException("EdgeMethods.Create not yet implemented for FastDB");
        }

        public Task<List<Edge>> CreateMany(Guid tenantGuid, Guid graphGuid, List<Edge> edges, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.CreateMany not yet implemented for FastDB");
        }
        ...
        {
            throw new NotImplementedException("EdgeMethods.ReadAllInTenant not yet implemented for FastDB");
        }
        ...
        {
            throw new NotImplementedException("EdgeMethods.ReadAllInGraph not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.ReadMany not yet implemented for FastDB");
        }
        ...
        {
            throw new NotImplementedException("EdgeMethods.ReadFirst not yet implemented for FastDB");
        }

        public Task<Edge> ReadByGuid(Guid tenantGuid, Guid edgeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.ReadByGuid not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.ReadByGuids not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.GetEdgesFromNode not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.GetEdgesToNode not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.GetEdgesBetweenNodes not yet implemented for FastDB");
        }
        ...
        {
            throw new NotImplementedException("EdgeMethods.GetRecordCount not yet implemented for FastDB");
        }

        public Task<Edge> Update(Edge edge, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.Update not yet implemented for FastDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid graphGuid, Guid edgeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteByGuid not yet implemented for FastDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteAllInTenant not yet implemented for FastDB");
        }

        public Task DeleteAllInGraph(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteAllInGraph not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.ReadNodeEdges not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.ReadEdgesFromNode not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.ReadEdgesToNode not yet implemented for FastDB");
        }
        ...
        { yield break; throw new NotImplementedException("EdgeMethods.ReadEdgesBetweenNodes not yet implemented for FastDB");
        }

        public Task<EnumerationResult<Edge>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.Enumerate not yet implemented for FastDB");
        }

        public Task DeleteNodeEdges(Guid tenantGuid, Guid graphGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteNodeEdges not yet implemented for FastDB");
        }

        public Task DeleteNodeEdges(Guid tenantGuid, Guid graphGuid, List<Guid> nodeGuids, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteNodeEdges (multiple nodes) not yet implemented for FastDB");
        }

        public Task DeleteMany(Guid tenantGuid, Guid graphGuid, List<Guid> edgeGuids, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteMany not yet implemented for FastDB");
        }
        public Task DeleteByNodeGuid(Guid tenantGuid, Guid graphGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.DeleteByNodeGuid not yet implemented for FastDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid edgeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("EdgeMethods.ExistsByGuid not yet implemented for FastDB");
        }
    }
}
