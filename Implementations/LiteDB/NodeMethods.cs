...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations.LiteDB{
    ...
    public class NodeMethods : INodeMethods
    {
        ...
        {
            throw new NotImplementedException("NodeMethods.Create not yet implemented for LiteDB");
        }

        public Task<List<Node>> CreateMany(Guid tenantGuid, Guid graphGuid, List<Node> nodes, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.CreateMany not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadAllInTenant not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadAllInGraph not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadMany not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadMostConnected not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadLeastConnected not yet implemented for LiteDB");
        }
        ...
        {
            throw new NotImplementedException("NodeMethods.ReadFirst not yet implemented for LiteDB");
        }

        public Task<Node> ReadByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.ReadByGuid not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadByGuids not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadParents not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadChildren not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadNeighbors not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("NodeMethods.ReadRoutes not yet implemented for LiteDB");
        }

        public Task<EnumerationResult<Node>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.Enumerate not yet implemented for LiteDB");
        }
        ...
        {
            throw new NotImplementedException("NodeMethods.GetRecordCount not yet implemented for LiteDB");
        }

        public Task<Node> Update(Node node, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.Update not yet implemented for LiteDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid graphGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.DeleteByGuid not yet implemented for LiteDB");
        }

        public Task DeleteMany(Guid tenantGuid, Guid graphGuid, List<Guid> nodeGuids, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.DeleteMany not yet implemented for LiteDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.DeleteAllInTenant not yet implemented for LiteDB");
        }

        public Task DeleteAllInGraph(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.DeleteAllInGraph not yet implemented for LiteDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.ExistsByGuid not yet implemented for LiteDB");
        }

        public Task<bool> ExistsByName(Guid tenantGuid, Guid graphGuid, string name, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.ExistsByName not yet implemented for LiteDB");
        }

        public Task<Node> ReadByName(Guid tenantGuid, Guid graphGuid, string name, CancellationToken token = default)
        {
            throw new NotImplementedException("NodeMethods.ReadByName not yet implemented for LiteDB");
        }
    }
}
