...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations.LiteDB{
    ...
    public class VectorMethods : IVectorMethods
    {
        ...
        {
            throw new NotImplementedException("VectorMethods.Create not yet implemented for LiteDB");
        }

        public Task<List<VectorMetadata>> CreateMany(Guid tenantGuid, List<VectorMetadata> vectors, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.CreateMany not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadAllInTenant not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadAllInGraph not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadMany not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadManyGraph not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadManyNode not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadManyEdge not yet implemented for LiteDB");
        }

        public Task<VectorMetadata> ReadByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.ReadByGuid not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.ReadByGuids not yet implemented for LiteDB");
        }

        public Task<EnumerationResult<VectorMetadata>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.Enumerate not yet implemented for LiteDB");
        }
        ...
        {
            throw new NotImplementedException("VectorMethods.GetRecordCount not yet implemented for LiteDB");
        }

        public Task<VectorMetadata> Update(VectorMetadata vector, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.Update not yet implemented for LiteDB");
        }
        ...
        {
            throw new NotImplementedException("VectorMethods.DeleteMany not yet implemented for LiteDB");
        }

        public Task DeleteMany(Guid tenantGuid, List<Guid> guids, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteMany (by guids) not yet implemented for LiteDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteAllInTenant not yet implemented for LiteDB");
        }

        public Task DeleteAllInGraph(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteAllInGraph not yet implemented for LiteDB");
        }

        public Task DeleteGraphVectors(Guid tenantGuid, Guid graphGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteGraphVectors not yet implemented for LiteDB");
        }

        public Task DeleteNodeVectors(Guid tenantGuid, Guid graphGuid, Guid nodeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteNodeVectors not yet implemented for LiteDB");
        }

        public Task DeleteEdgeVectors(Guid tenantGuid, Guid graphGuid, Guid edgeGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteEdgeVectors not yet implemented for LiteDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.ExistsByGuid not yet implemented for LiteDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("VectorMethods.DeleteByGuid not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.SearchGraph not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.SearchNode not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("VectorMethods.SearchEdge not yet implemented for LiteDB");
        }
    }
}
