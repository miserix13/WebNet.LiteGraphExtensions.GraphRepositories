...
namespace WebNet.LiteGraphExtensions.GraphRepositories.Implementations.LiteDB{
    ...
    public class UserMethods : IUserMethods
    {
        ...
        {
            throw new NotImplementedException("UserMethods.Create not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("UserMethods.ReadAllInTenant not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("UserMethods.ReadMany not yet implemented for LiteDB");
        }

        public Task<UserMaster> ReadByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.ReadByGuid not yet implemented for LiteDB");
        }
        ...
        { yield break; throw new NotImplementedException("UserMethods.ReadByGuids not yet implemented for LiteDB");
        }

        public Task<List<TenantMetadata>> ReadTenantsByEmail(string email, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.ReadTenantsByEmail not yet implemented for LiteDB");
        }

        public Task<UserMaster> ReadByEmail(Guid tenantGuid, string email, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.ReadByEmail not yet implemented for LiteDB");
        }

        public Task<EnumerationResult<UserMaster>> Enumerate(EnumerationRequest query, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.Enumerate not yet implemented for LiteDB");
        }
        ...
        {
            throw new NotImplementedException("UserMethods.GetRecordCount not yet implemented for LiteDB");
        }
        ...
        {
            throw new NotImplementedException("UserMethods.GetRecordCount (simple) not yet implemented for LiteDB");
        }

        public Task<UserMaster> Update(UserMaster user, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.Update not yet implemented for LiteDB");
        }

        public Task DeleteAllInTenant(Guid tenantGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.DeleteAllInTenant not yet implemented for LiteDB");
        }

        public Task<bool> ExistsByGuid(Guid tenantGuid, Guid userGuid, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.ExistsByGuid not yet implemented for LiteDB");
        }

        public Task<bool> ExistsByEmail(Guid tenantGuid, string email, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.ExistsByEmail not yet implemented for LiteDB");
        }

        public Task DeleteByGuid(Guid tenantGuid, Guid guid, CancellationToken token = default)
        {
            throw new NotImplementedException("UserMethods.DeleteByGuid not yet implemented for LiteDB");
        }
    }
}
